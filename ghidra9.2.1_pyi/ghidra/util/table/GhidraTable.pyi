...
class GhidraTable(docking.widgets.table.GTable):
    ...
    def navigate(self, row: int, column: int) -> None:
        """
    ...
    def setNavigateOnSelectionEnabled(self, enabled: bool) -> None:
        """
    ...
    def setValueAt(self, aValue: object, row: int, column: int) -> None: ...
