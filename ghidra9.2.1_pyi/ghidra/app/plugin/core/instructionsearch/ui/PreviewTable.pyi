...
class PreviewTable(ghidra.app.plugin.core.instructionsearch.ui.AbstractInstructionTable):
    HEADER_COL_PREVIEW: unicode = u'Search String Preview'




    class ViewType(java.lang.Enum):
        BINARY: ghidra.app.plugin.core.instructionsearch.ui.PreviewTable.ViewType = BINARY
        HEX: ghidra.app.plugin.core.instructionsearch.ui.PreviewTable.ViewType = HEX
        ...
        @overload
        @staticmethod
        def valueOf(__a0: unicode) -> ghidra.app.plugin.core.instructionsearch.ui.PreviewTable.ViewType: ...
        ...
        @staticmethod
        def values() -> List[ghidra.app.plugin.core.instructionsearch.ui.PreviewTable.ViewType]: ...
    ...
    def addPreviewString(self, __a0: unicode, __a1: int) -> None: ...
    ...
    def setPreviewText(self, __a0: int, __a1: unicode) -> None: ...
